/****** Object:  StoredProcedure [dbo].[UpdateWatermarkColumnValue]    Script Date: 11/6/2025 4:01:17 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROC [dbo].[UpdateWatermarkColumnValue] 
	@Type						NVARCHAR(10),
